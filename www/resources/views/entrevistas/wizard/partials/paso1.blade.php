        ...
        <div class="row">
            ...
            <div class="col-md-6" id="detalle_idiomas_container" style="display:none;">
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="detalle_idiomas" name="detalle_idiomas" rows="2" placeholder="Especifique el o los idiomas..."></textarea>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <small class="form-text text-muted">Se pre-rellena con su nombre. Puede modificarlo si aplica.</small>
                </div>
            </div>
