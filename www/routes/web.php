...
Route::middleware(['auth'])->group(function () {
    ...
    Route::middleware(['compromiso.reserva'])->group(function () {
        ...
        Route::middleware(['nivel:procesamientos.transcripcion'])->group(function () {
            ...
            Route::get('procesamientos/transcripcion/individual/estado', [ProcesamientoController::class, 'transcripcionIndividualEstado'])->name('procesamientos.transcripcion-individual-estado');
            ...
            Route::get('procesamientos/transcripcion/lote/estado', [ProcesamientoController::class, 'transcripcionLoteEstado'])->name('procesamientos.transcripcion-lote-estado');
